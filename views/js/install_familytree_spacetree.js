			...
			function view_member(id) {
				...
				$("#familytree_leftinfo").html(message).load("install.php?stage=view_member&id=" + id);
			...
			function delete_member(id) {
				$.ajaxSetup ({ cache: false });
				var message = "جاري التحميل...";
				$("#familytree_leftinfo").html(message).load("install.php?stage=delete_member&id=" + id);
